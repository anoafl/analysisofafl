...
Well one way to do this is by using `names(df3)` this will give you the names of all your columns another way to think about it, is its a quick way to list the variables. 
