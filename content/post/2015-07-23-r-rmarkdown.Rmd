...
1. Gary Ablett (Nguyen's projected odds to poll most votes  4.67 , actual WA TAB odds to win 4)
2. Nathan Fyfe (6, ineligible)
3. Matthew Priddis (9.80,  17 )
4. Dayne Beams ( 12 ,  67 )
5. Scott Pendlebury ( 12,  17 )
6. Joel Selwood ( 16.75 ,  2.70 )
7. Jordan Lewis ( 22 ,  9.75 )
8. Robbie Gray ( 19 ,  6 )
9. Tom Rockliff ( 19 , ineligible)
10. Luke Parker ( 27 ,  101 )

## Previous Brownlow "predictions" under the Nguyen model (with actual placings in bracket):

* 2009: Gary Ablett (1st), Dane Swan (eq 16th), Nick Dal Santo (eq 6th), Jonathan Brown (eq 4th), Leigh Montagna (eq 14th)
* 2010: Gary Ablett (2nd), Dane Swan (3rd), Luke Hodge (eq 9th), Brent Harvey (eq 16th), Lance Franklin (eq  25th)
* 2011: Dane Swan (1st), Matthew Boyd (eq 4th), Sam Mitchell (2nd), Marc Murphy (eq 9th), Scott Pendlebury (eq 4th)
* 2012: Jobe Watson (1st), Josh Kennedy (eq 8th), Gary Ablett (6th), Scott Thompson (eq 4th), Dane Swan (eq 4th)
* 2013: Gary Ablett (1st), Joel Selwood (2nd), Dane Swan (3rd), Nat Fyfe (11th), Steve Johnson (4th) 