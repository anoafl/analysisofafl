...
So looking at the dataset if we look at the `Seasons` column the first 4 characters are the first season the player has played, and our end of sequence should be the last 4 characters.
