...
Before you get all angry and don't @me here me out. Linear regression is a powerful tool and can even form part of a [PhD thesis](https://researchbank.rmit.edu.au/eserv/rmit:160744/Ryall.pdf) in statistics. Its a great building block to build from just as more commonly used ELOS are another great building block and another post. 
...
X0 <- as.data.frame(matrix(0,nrow(matches),length(all.teams)))
names(X0) <- all.teams
...
sc<-as.data.frame(coef(summary(mod)))
