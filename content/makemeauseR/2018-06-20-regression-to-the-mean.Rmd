...
We also see this in sports, Hollinger refers to it as the [fluke rule](http://www.espn.com/nba/columns/story?columnist=hollinger_john&page=All-Decline-Team-081031). Bill James calls it the [plexiglas principle](http://grantland.com/the-triangle/fantasy-baseball-nerdy-keys-to-victory-the-plexiglas-principle/), you might call it the [Sports Illustrated curse](https://en.wikipedia.org/wiki/Sports_Illustrated_cover_jinx). They all are different names from different people who have observed the same thing mean reversion or regression to the mean. 
