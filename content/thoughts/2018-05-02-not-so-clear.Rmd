...
The purpose of model selection is to choose a model from all possible models with desirable properties. Usually this would involve minimising the `$description loss + \lambda \cdot Model complexity$`
...
![Caption for the picture.](/img/varsel.png)
...
![Caption for the picture.](/img/varsel2.png)
![Caption for the picture.](/img/varsel3.png)
...
[Murray, K., Heritier, S. and Müller, S., 2013. Graphical tools for model selection in generalized linear models. Statistics in medicine, 32(25), pp.4438-4451.](http://onlinelibrary.wiley.com/doi/10.1002/sim.5855/abstract)